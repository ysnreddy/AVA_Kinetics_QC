...
KEYFRAMES_ROOT_DIR = st.sidebar.text_input("Root Directory (Parent of batch folders)", default_path)
...
# ==============================================================================
    ...
    manifest = st.text_input("Manifest Path", "outputs/factory_batch_01/manifest.json")

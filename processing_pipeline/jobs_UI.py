...
package_dir_str = st.sidebar.text_input("Path to Output Packages Directory", "F:/ava_kinetics - Copy/AVA_kinetics_multiAnnotator_pipeline/proposal_generation_pipeline/proposal_generation_pipeline/outputs/factory_batch_01")
